...
// For demo purposes assign range from the current date
    ...
    data () {
      return {
        ...
        tab: null,
        table_header:[
          "Job#","Order#","ลูกค้า","Booking No","ประเภทงาน","เบอร์ตู้","ขนาดตู้","สถานที่รับตู้","วันที่รับตู้","สถานที่ส่งตู้ (Load)","วันที่ส่งตู้ (Load)","สถานที่คืนตู้","วันที่คืนตู้","ค่า่ใช้จ่าย","ค่าน้ำมัน","ค่าซ่อม","กำไร","GP%"
        ],
        table_body: [     
          {
              job_id: '1',
